...
// These macros create some functions like InitHealth, SetHealth, GetHealth, and GetHealthAttribute
// To debug in game, open the console and type showdegub abilitysystem
